 ...
 * \file vulkan2_common.h
 * \brief Vulkan2 common header
 */
#pragma once
...
struct Vulkan2DescriptorTemplateKHRFunctions {
...
struct Vulkan2GetBufferMemoryRequirements2Functions {
  PFN_vkGetBufferMemoryRequirements2KHR vkGetBufferMemoryRequirements2KHR{nullptr};
};

struct Vulkan2StagingBuffer {
...
struct Vulkan2Context {
  ...
  std::unique_ptr<Vulkan2DescriptorTemplateKHRFunctions> descriptor_template_khr_functions{nullptr};
